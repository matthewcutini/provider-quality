...
# MAGIC %md
# MAGIC #Create Config Text#
# MAGIC
# MAGIC In Cell 10 we turn off the numbers that Synthea appends to the end of names in order to plainly show that they are synthetic
# MAGIC
# MAGIC We also turn on clinical_note module
