...
dbutils.widgets.text(name = "min_records", defaultValue="1000", label = "Minimum Generated Record Count")
dbutils.widgets.text(name = "max_records", defaultValue="10000", label = "Maximum Generated Record Count")
...
run_results = data_generator(
  ...
  ,additional_options="Nevada 'Reno'"
  ,verbose=True
)
