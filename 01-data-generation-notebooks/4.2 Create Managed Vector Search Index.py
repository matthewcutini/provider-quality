...
source_table_fullname = "matt_cutini_tiz9_da.default.pdf_text_embeddings"
#
...
if not index_exists(vsc, vs_endpoint_name, vs_index_fullname):
  ...
  vsc.get_index(endpoint_name=vs_endpoint_name, index_name=vs_index_fullname).sync()
...
question = "How high is the risk that generative models will replace human workers?"
