...
# DBTITLE 1,Copy new files from synthetic_files_raw/output/csv folder to landing zone
import os
...
# DBTITLE 1,Copy new files from synthetic_files_raw/output/notes to landing zone
source_path = "/Volumes/mcutini/synthea/synthetic_files_raw/output/notes/"
target_path = "/Volumes/mcutini/synthea/landing/notes/"
